...
export function Scoreboard({ score, totalCells, isComplete }: ScoreboardProps) {
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="h-1.5 rounded-full bg-neutral-200 overflow-hidden" role="progressbar" aria-label={t('scoreboard.cells', { score, total: totalCells })} aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100}>
        <div
